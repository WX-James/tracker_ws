...
"""autogenerated by genpy from mpc/Polynome.msg. Do not edit."""
import codecs
import sys
...
class Polynome(genpy.Message):
  _md5sum = "7ebb28d15fc23e8cb6152349792357d1"
  _type = "mpc/Polynome"
...
float64 y
float64 z"""
  __slots__ = ['start_time','pos_pts','init_v','init_a','t_pts']
  _slot_types = ['time','geometry_msgs/Point[]','geometry_msgs/Vector3','geometry_msgs/Vector3','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       start_time,pos_pts,init_v,init_a,t_pts
