...
class Local_Planner():
    def __init__(self):
        ...
        self.__pub_rtc_cmd = rospy.Publisher('/robot1/cmd_vel', Twist, queue_size=10)                                      # cmd_vel的发布者，发布由MPC求解出的最优控制
        self._sub_odom = rospy.Subscriber('/state_ukf/odom1', Odometry, self.__odom_cb)                              # 里程的订阅者，订阅里程计获得小车的位置
